...
import SecurityManager from "../../pages/ManitouPage";
...
Given('User enter the username in security Manager', async function () {
    await securityManagerPage.enterUserName(data.userNameManitou)
});

Given('User enter the password in security Manager', async function () {
    await securityManagerPage.enterPassword(data.passwordManitou)
})
